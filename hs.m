function BestSol=hs(min1,max1,Var,Itr)

%% Problem Definition

CostFunction=@(x) Sphere(x);        % Cost Function

nVar=Var;             % Number of Deciison Variables

VarSize=[1 nVar];   % Decision Variables Matrix Size

VarMin=min1;         % Decision Variables Lower Bound
VarMax= max1;         % Decision Variables Upper Bound
